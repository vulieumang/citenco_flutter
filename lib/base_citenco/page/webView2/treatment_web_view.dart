...
class TreatmentWebView extends StatelessWidget {
  const TreatmentWebView({ Key? key }) : super(key: key);
  
  @override
  Widget build(BuildContext context) {
    return FeedBackWebPage(
      urlView:  BaseScope().env?.env == "staging"
      ? 'https://social-staging.cnvloyalty.com/${BaseScope().env?.accountDomainName}/treatment/list'
      : 'https://social.cnvloyalty.com/${BaseScope().env?.accountDomainName}/treatment/list'
    );
  }
}
