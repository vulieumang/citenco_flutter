          ...
          children: [
            ...
            Container(
              child: Text(
                ...
                style: BasePKG().text!.normalBold().copyWith(color: Colors.white),
              ),
            ),
          ],
        ),
      ...
      child: Center(
        child: Container( 
          ...
          child: Stack(
              ...
              children: [
                Image.asset("lib/base_citenco/asset/image/bg_home_bottom.png",width: size.width,),
                Container(
                  height: size.height,
                  width: size.width,
                  child: Column(
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            child: Text(
                              "Đăng xuất",
                              style: BasePKG().text!.largeLowerBold().copyWith(decoration: TextDecoration.underline),
                              maxLines: 2,
                              textAlign: TextAlign.center,
                            ),
                          ),
                          SizedBox(width: 10,),
                          Image.asset("lib/base_citenco/asset/image/ic_logout.png",width: 20,height: 20, )
                        ],
                      ),
                      SizedBox(height: 50,),
                      Text(
                        "Vui lòng chọn",
                        style: BasePKG().text!.captionNormal().copyWith(color: Colors.black.withOpacity(.7)),
                        maxLines: 2,
                        textAlign: TextAlign.center,
                      ),
                      SizedBox(height: 50,),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                "Quét xe vào trạm",
                                style: BasePKG().text!.captionBlack().copyWith(color: Color(0xff004D99)),
                              ),
                              SizedBox(width: 14,),
                              Image.asset("lib/base_citenco/asset/image/ic_location_xe.png",width: 25,height: 25,)
                            ],
                          ),
                        ),
                      ),
