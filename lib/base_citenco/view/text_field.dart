              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    onTap: widget.onTap,
                    style: BasePKG().text!.normalNormal().copyWith(height: 1.2),
                    ...
                    decoration: InputDecoration(
                        ...
                        suffix: Container(
                          ...
                          child: widget.enablePass!? 
                            GestureDetector(
                              ...
                              child: Container(
                                child: Text(
                                   obscureText!?"${BaseTrans().$presently}": "${BaseTrans().$hide}",
                        ...
                        labelStyle: BasePKG()
                            .text!
                            .normalNormal()
                            .copyWith(color: BasePKG().color.text.withOpacity(0.6), height: 0.8)),
                  ),
                ),
              )
            ]),
