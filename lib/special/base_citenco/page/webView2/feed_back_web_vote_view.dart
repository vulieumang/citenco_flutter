...
class FeedBackVoteWebView extends StatelessWidget {
  const FeedBackVoteWebView({ Key? key }) : super(key: key);
  
  @override
  Widget build(BuildContext context) {
    return FeedBackWebPage(
      urlView:  BaseScope().env?.env == "staging"
      ? 'https://social-staging.cnvloyalty.com/${BaseScope().env?.accountDomainName}/customer-experience/feedback-vote/list'
      : 'https://social.cnvloyalty.com/${BaseScope().env?.accountDomainName}/customer-experience/feedback-vote/list'
    );
  }
}
