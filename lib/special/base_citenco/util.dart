...
//   }
  ...
  // static String generateBarcode(String code,
  //     {bool drawText: false, double width = 200, double height = 80}) {
  //   return Barcode.code128().toSvg(BasePKG().stringOf(() => code),
  ...
  static String generateQRCode(String code,
      {bool drawText: false, double width = 100, double height = 100}) {
    return Barcode.qrCode().toSvg(BasePKG().stringOf(() => code),
        fontFamily: "HelveticaNeue",
        drawText: drawText,
        width: width,
        height: height);
