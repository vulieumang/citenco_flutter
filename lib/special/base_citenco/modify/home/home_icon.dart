...
class HomeIcon {
  ...
  factory HomeIcon.multiColor(
    ...
    return HomeIcon(
        ...
        asset: asset,
        name: BasePKG().upperCaseFirstHomeIconTitle
            ? Utils.upperCaseFirst(name)
            : Utils.upperCaseFullFirst(name),
        onTap: _onTap,
        iconSize: iconSize,
        fillColor: false);
  }
  ...
  factory HomeIcon.fromServer({
    ...
    return HomeIcon(
        ...
        versionHide: versionHide,
        name: BasePKG().upperCaseFirstHomeIconTitle
            ? Utils.upperCaseFirst(_name)
            : Utils.upperCaseFullFirst(_name),
        onTap: _onTap,
